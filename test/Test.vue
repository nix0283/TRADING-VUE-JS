...
import TimeframesDemo from './tests/TimeframesDemo.vue'
import TimeframesIntegrated from './tests/TimeframesIntegrated.vue'
import BTCRealDataDemo from './tests/BTCRealDataDemo.vue'
...
const TESTS = {
    Simple, Stocks, Timeframes, TimeframesDemo, TimeframesIntegrated, BTCRealDataDemo, Multichart,
