...
* **Built-in Timeframe Selector** (TradingView style) 🆕
...
Built-in TradingView-style timeframe selector with all standard periods:
...
| Minutes | `1m`, `2m`, `3m`, `5m`, `10m`, `15m`, `20m`, `30m`, `45m` |
| Hours | `1H`, `2H`, `3H`, `4H`, `6H`, `8H`, `12H` |
| Days | `D`, `2D`, `3D` |
| Weeks | `W`, `2W` |
| Months | `M`, `3M`, `6M`, `12M`, `Y` |

### Props

| Prop | Type | Default | Description |
|------|------|---------|-------------|
| `timeframes` | Boolean | `false` | Enable timeframe selector |
| `timeframe` | String | `'1D'` | Current timeframe (sync) |
| `timeframe-style` | String | `'dropdown'` | `'dropdown'` or `'full'` |
| `timeframe-extended` | Boolean | `false` | Show extended TF list |

### Events

| Event | Payload | Description |
|-------|---------|-------------|
| `timeframe-change` | `tf: string` | Fired when TF changes |

### Keyboard Shortcuts

`1` `3` `5` → Minutes | `H` → 1 Hour | `4` → 4 Hours | `D` → Day | `W` → Week | `M` → Month
